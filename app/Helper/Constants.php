...
class Constants
{
    ...
    const LATE_FEE_DEDUCTION_NOTIFICATION_ERROR = 'An Error Occurred while trying to send Late Fee Deduction notification to customer customer_name with Order order_number';
