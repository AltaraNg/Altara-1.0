                        ...
                        this.$validator.validateAll().then(function (result) {
                           if (result) {
                              if (_this2.$network()) {
                                 _this2.$LIPS(true);
                                 _this2.error = {};
                                 (0, _api.byMethod)(_this2.method, _this2.store, _this2.form).then(function (res) {
                                    if (res.data.saved || res.data.updated) {
                                       (0, _log.log)('Branch ' + _this2.mode + 'd', '' + _this2.form.employee_id);
                                       _flash2.default.setSuccess('Branch ' + _this2.mode + 'd successfully!', 20000);
                                    }
                                 }).catch(function (e) {
                                    e = e.response;
                                    if (e.status === 422) {
                      ...
                      [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _vm._l(_vm.$store.getters.getStates, function(
                              state
                            ) {
                              return _c(
                                "option",
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm._f("capitalize")(state.name))
                                  )
                                ]
                              )
                            })
                          ...
                          [
                            ...
                            _vm._l(_vm.banks, function(bank) {
                              return _c(
                                ...
                                [
                                  _vm._v(
                                    _vm._s(_vm._f("capitalize")(bank.name))
                                  )
                                ]
                              )
                            })
