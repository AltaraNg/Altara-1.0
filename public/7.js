...
exports.default = {
    ...
    methods: {
        sendMessage: function sendMessage() {
            ...
            (0, _api.post)('/api/message', this.form).then(function (res) {
