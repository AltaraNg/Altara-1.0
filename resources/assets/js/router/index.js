...
const AltaraPayReport = () => import('../views/FSL/altara-pay-report/form.vue');
    ...
    routes: [
        ...
        },
        {
            path: '/fsl', component: FSL, meta: {FSL: true}, children: [
                ...
                {path: 'altara-pay-report/create', component: AltaraPayReport, name: 'altara-pay-report', meta: {mode: 'create'}},
