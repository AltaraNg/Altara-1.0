    ...
    <div id="reminder">
        <div class="mt-5 mb-3 attendance-head">
            <ul class="nav nav-tabs justify-content-center p-0" role="tablist">
                ...
                <li class="col p-0 nav-item mb-0">
                    <a aria-selected="false" class="nav-link" data-toggle="tab" href="#reminder-4"
                       role="tab">4<sup>th</sup> Reminder</a>
                </li>
                <li class="col p-0 nav-item mb-0">
                    <a aria-selected="false" class="nav-link" data-toggle="tab" href="#reminder-5"
                       role="tab">5<sup>th</sup> Reminder (Promise Call)</a>
                </li>
            </ul>
        </div>
        <div class="mt-5 mb-3 attendance-head">
