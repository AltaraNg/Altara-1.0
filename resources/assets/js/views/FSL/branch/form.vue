               ...
               <form @submit.prevent="onSave" v-if="show">
                  ...
                  <div class="clearfix">
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <input :class="{'is-invalid': error.name}" class="form-control" data-vv-as="branch name" name="branch_name"
                               placeholder="branch name" type="text" v-model="form.name" v-validate="'required'">
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <select class="custom-select w-100" data-vv-validate-on="blur" name="state"
                           ...
                           <option :value="state.id" v-for="state in $store.getters.getStates">{{state.name | capitalize}}</option>
                        </select>
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <div class="radio pl-1 w-50 pr-3 float-left">
                           <input id="active" name="status" type="radio" v-model="form.status" v-validate="'required'"
                                  value="active">
                           <label for="active">Active</label>
                        </div>
                        <div class="radio pl-1 w-50 pr-3 float-left">
                           <input id="passive" name="status" type="radio" v-model="form.status" value="passive">
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <textarea class="form-control w-100" name="description" placeholder="address description"
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        <label>Email</label>
                        <input :class="{'is-invalid': error.email}" class="form-control" name="email" placeholder="name@example.com"
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <input class="form-control" data-vv-as="account name" name="account_name" placeholder="branch name"
                     ...
                     <div class="form-group col-md-6 col-12 float-left px-0 px-md-3">
                        ...
                        <input :class="{'is-invalid': error.account_number}" class="form-control" data-vv-as="account number"
