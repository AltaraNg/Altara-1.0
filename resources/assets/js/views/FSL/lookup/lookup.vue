                ...
                <div v-if="customer && show">
                    ...
                    <div class="tab-content mt-1 attendance-body">
                        <div
                            ...
                            v-if="show && customer.orders.length > 0"
                        >
                            <div
                        ...
                        <div class="modal-body">
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered">
                                    <tbody class="text-center">
                                        ...
                                        <tr class="table-separator">
                                            <th>Due Date</th>
                                            <td
                                                v-for="date in activeOrder.dueDates"
                                            >
                                                {{ date }}
                                            </td>
                                        </tr>
                                ...
                                <table class="table table-bordered">
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                {{
                                                    activeOrder.discountedTotal
                                                }}
                                            </th>
                                            <td>Total Debt</td>
                                            <th>
                                                {{
                                                    activeOrder.outstandingDebt
                                                }}
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            <th>
                                                {{
                                                    activeOrder.totalPlusDefault
                                                }}
                                            </th>
                                            <td>Default Fee</td>
                                            <th>
                                                {{ activeOrder.defaultFee }}
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <div v-if="canEditPayment && !isReadOnly">
                                    <h5 class="mt-5 mb-0">
                                        {{ paymentFormType | capitalize }} a new
                                        payment
                                    </h5>
                                    <table class="table table-bordered">
                                        <tbody class="text-center">
            ...
            post(`/api/repayment`, data)
                .then(async res => {
                    if (res.data.saved) {
                        ...
                        this.activeOrder = await new Order(
                            order,
                            this.customer
                        );
                        ...
                        if (
                            this.activeOrder.repaymentLevel ===
                            this.activeOrder.count
                        )
