            ...
            <form @submit.prevent="onSave">
               <div class="my-4 clearfix p-5 row bg-white shadow-sm" style="border-radius: .4rem">
                  <div class="form-group col-12 float-left px-0 px-md-3">
                     ...
                     <input class="form-control mb-2" placeholder="category name" name="category name" type="text" v-model="form.name"
               ...
               <div class="mb-5 px-0 row align-items-center">
                  <div class="clearfix d-flex justify-content-end w-100">
                     <router-link to="/log/categories" class="mx-5 text-link mt-4 pt-2" v-if="mode ==='edit'">Cancel</router-link>
