        ...
        <form @submit.prevent="register">
          ...
          <div v-if="mode === 'register'">
            ...
            <div class="form-group col-md-6 px-md-3 px-1 float-left">
              ...
              >{{errors.first('number_of_children')}}</small>
            </div>
              ...
              <div v-if="newCustomer.employment_status === 'formal'">
                ...
                <div class="form-group col-md-6 px-md-3 px-1 float-left">
                  ...
                  <input
                    ...
                    v-validate="'required'"
                  />
                  <small v-if="errors.first('current_salary')">{{errors.first('current_salary')}}</small>
                </div>
                ...
                <div class="form-group col-md-4 px-md-3 px-1 float-left">
                  ...
                  <input
                    ...
                    v-validate="'required'"
                  />
                  <small v-if="errors.first('available_from')">{{errors.first('available_from')}}</small>
                </div>
            ...
            <div class="form-group col-md-4 px-md-3 px-1 float-left">
              ...
              <small v-if="errors.first('NOK_work_duration')">{{errors.first('NOK_work_duration')}}</small>
            </div>
