                            ...
                            <div style="width:100% !important;">
                                ...
                                <div
                                    ...
                                    <div class="button-container" align="left"
                                        ...
                                        <p>Dear {{$clientName}},</p>
                                        <p>We are pleased to inform you that your account has been successfully created with Altara.</p>
                                        <p>To complete the setup process, please verify your email address by clicking the link below:</p>
                                        <a href="{{$verificationLink}}" id="verification-button">Verify Email Address</a>
                                        <p>This verification ensures the security of your account and enables you to access all the features and services we offer.</p>
                                        <p>If you did not request this account or if you have any questions, please contact our support team at {{config('app.admin_email')}}.</p>
                                        <p>Thank you for choosing Altara. We look forward to serving you.</p>
