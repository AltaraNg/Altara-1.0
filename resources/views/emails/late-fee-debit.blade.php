                                ...
                                <div class="col num12"
                                    ...
                                    <![endif]-->
                                            <div class="button-container" align="left"
                                                style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                <p>Dear {{ $data['customer_name'] }}, This is a notification of late fee
                                                    debit on your overdue order <b>{{ $data['order_number'] }}</b>.</p>
                                                ...
                                                <div class="customer">
                                                    ...
                                                    <p><b>No of Completed Repayments:</b> {{ $completedRepayment }}
                                                    </p>
                                                    <p><b>Late Fee Accrued:</b> {{ $completedRepayment }}</p>

                                                    @if ($rep = $amortization->where('actual_payment_date', null)->first())
                                                        <p><b>No of Repayments Left:</b>
                                                            {{ $amortization->where('actual_payment_date', null)->count() }}
                                                        </p>
                                                        <p><b>Next Payment Date:</b> {{ $rep->expected_payment_date }}
                                                        </p>
