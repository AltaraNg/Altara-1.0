                                ...
                                <div
                                    ...
                                    <div class="button-container" align="left"
                                         ...
                                         <div class="customer">
                                             ...
                                             <p><b>Phone Number:</b>  {{$customer->telephone}}</p>
                                        ...
                                        <div class="customer">
                                            <h3>Bank Statement Detail</h3>
                                            <p><b>Account Number:</b> {{$missMatchedData['expected_account_number']}}</p>
                                            <p><b>Account Name:</b> {{$missMatchedData['expected_account_name']}}</p>
                                            <p><b>Bank Name:</b> {{$missMatchedData['expected_bank_name']}}</p>
                                        </div>

                                        <div class="customer">
                                            <h3>Credit Card Detail</h3>
                                            <p><b>Account Number:</b> {{$missMatchedData['actual_account_number']}}</p>
                                            <p><b>Account Name:</b> {{$missMatchedData['actual_account_name']}}</p>
                                            <p><b>Bank Name:</b> {{$missMatchedData['actual_bank_name']}}</p>
                                        </div>
                                    </div>
                                    <!--[if mso]>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
