...
use App\Http\Controllers\CustomerContactNotificationController;
...
use App\Http\Controllers\RenewalListStatusController;
use App\Http\Controllers\RenewalPrompterController;
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    /*------*/
    Route::get('/users/list_type/{type}', [UserController::class, 'getListForTypeahead']);
    Route::post('/user/{id}/cv', [UserController::class, 'uploadCV']);
    Route::post('/logout', [AuthController::class, 'logout']);
    Route::get('/create', [AuthController::class, 'create']);
    Route::post('/register', [AuthController::class, 'register']);
    Route::get('/employee/{id}/edit', [AuthController::class, 'edit']);
    Route::post('/employee/{id}/update', [AuthController::class, 'update']);
    Route::get('/reset-password/{id}', [AuthController::class, 'resetPassword']);
    Route::get('/orders/user/{id}', [OrderController::class, 'ordersByUser']);
    ...
    Route::get('/renewal-list-status', [RenewalListStatusController::class, 'index']);
    Route::patch('/payment-reconcile/{payment_reconcile}/finance', [PaymentReconcileController::class, 'finance']);
    Route::patch('/brand/{brand}/categories', [BrandController::class, 'manageCategories']);
    Route::get('/inventory-summary', [InventoryController::class, 'summary']);
    Route::post('/sheet/product', [ProductController::class, 'uploadSheet']);
    Route::post('/sheet/inventory', [InventoryController::class, 'uploadSheet']);
    Route::post('/sheet/calculator', [PriceCalculatorController::class, 'uploadCalculator']);
    Route::get('/jobs', [ManualController::class, 'jobs']);
    Route::post('/no-auth', [ManualController::class, 'getNoAuth']);
    Route::post('/contact_notification/{customer}', [CustomerContactNotificationController::class, 'store']);
    Route::post('/customer/notification/{customer}', [CustomerNotificationController::class, 'store']);
    Route::post('/send-internal-message', [MessageController::class, 'sendStaffMessage']);
    Route::patch('/sales-category/{salesCat}/roles', [SalesCategoryController::class, 'manageRoles']);
    Route::patch('/new-order/{new_order}/repossess', [NewOrderController::class, 'repossess']);
    Route::get('/get-users', [UserController::class, 'getUsers']);
    Route::get('/contact-customer/export', [ContactCustomerController::class, 'export']);
    Route::get('/feedbacks/export', [FeedbackController::class, 'export']);
    Route::post('/recommendation', [AmortizationController::class, 'recommend']);
    Route::get('/customer-recommendation/{customer}', [RecommendationController::class, 'getRecommendationByCustomer']);
    Route::get('/order/reports', [NewOrderController::class, 'report']);
    Route::get('/order/reports/export', [ReportController::class, 'getNewOrdersReport']);
    ...
    Route::prefix('renewal/prompters')->group(function () {
        Route::get('/', [RenewalPrompterController::class, 'index']);
        Route::post('/', [RenewalPrompterController::class, 'store']);
        Route::get('/statuses', [RenewalPrompterController::class, 'prompterStatuses']);
        Route::get('/stats', [RenewalPrompterController::class, 'statistics']);
        Route::get('/history', [RenewalPrompterController::class, 'show']);
        Route::get('/customer-list', [RenewalPrompterController::class, 'customerList']);
    });
});
Route::middleware('auth:api')->group(function () {
    Route::resource('brand', BranchController::class)->except(['index', 'show']);
    Route::resource('website-product', WebsiteProductController::class)->except(['index', 'show']);
    Route::resource('inventory', InventoryController::class)->except(['index', 'show']);
    Route::resource('price_calculator', PriceCalculatorController::class)->except(['index', 'show']);
    Route::resource('down_payment_rate', DownPaymentRateController::class)->except(['index', 'show']);
    Route::resource('business_type', BusinessTypeController::class)->except(['index', 'show']);
    Route::resource('repayment_duration', RepaymentDurationController::class)->except(['index', 'show']);
